...
#Using Gabby's Logistic Model to educate which visualizations would be informative
log_model <- glm(Revenue ~ ., data=shopping, family="binomial")
summary(log_model)
...
Admin_vs_Prod <- ggplot(data = shopping, aes(x = Administrative, y = ProductRelated, colour = colrange)) + geom_jitter(alpha = 0.5)
Admin_vs_Prod + geom_point()
#Added Jitter because there was a lot of overlap

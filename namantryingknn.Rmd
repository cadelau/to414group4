...
shopping_n$Revenue <- as.numeric(shopping$Revenue) - 1
...
shopping_use_train_labels <- shopping_use[1:7000, 18]
shopping_use_test_labels <- shopping_use[7001:nrow(shopping_use), 18]


shopping_use_test_pred <- knn(train = shopping_use_train, test = shopping_use_test,
                      cl = shopping_use_train_labels, k=1)
